...
%define glibcrelease 307.%{alicloud_base_release}%{?dist}.1
##############################################################################
...
Patch10000: 0001-update-glibc-headers-with-the-define-EPOLLEXCLUSIVE.patch
Patch10001: 0002-glibc-tcache.patch
...
%changelog
* Wed Jun 24 2020 Chunmei Xu <xuchunmei@linux.alibaba.com> - 2.17-307.1.2
- TCache backport from glibc 2.26

* Thu May 14 2020 Wei Liu <alicloud-linux-os@service.aliyun.com> - 2.17-307.1.1
- Rebuild for Alibaba Cloud Linux
- Modify alicloud_base_release and Modify release and Re-tag
- update glibc headers with define EPOLLEXCLUSIVE
